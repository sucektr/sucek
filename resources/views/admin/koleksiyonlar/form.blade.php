      ...
      <div class="bg-white rounded-[12px] border border-[#E2E8F0] p-6">
        ...
        <div class="space-y-4">
          <div>
            ...
            <input type="text" name="ad" id="slug-kaynak" value="{{ old('ad', $koleksiyon->ad) }}" required
          ...
          <div>
            ...
            <input type="text" name="slug" id="slug-hedef" value="{{ old('slug', $koleksiyon->slug) }}" required
            ...
            <p class="text-[11px] text-[#94A3B8] mt-1">Addan otomatik oluşturulur, istediğinizde düzenleyebilirsiniz.</p>
