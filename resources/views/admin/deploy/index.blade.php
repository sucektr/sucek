    ...
    <div class="flex items-start gap-4">
      ...
      <div>
        ...
        <ul class="mt-2 space-y-0.5">
          @foreach(['git remote set-url (HTTPS)', 'git pull origin main', 'migrate --force', 'config:clear', 'config:cache', 'route:clear', 'route:cache', 'view:clear', 'view:cache', 'storage:link'] as $adim)
