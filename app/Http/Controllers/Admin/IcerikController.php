    ...
    private function sayfaTanimlari(): array
    {
        return [
            ...
            'anasayfa' => [
                'baslik'   => 'Ana Sayfa',
                'ikon'     => 'ti-home',
                'aciklama' => 'Banner, hero kart görselleri (8 panel), yaklaşım, referanslar + SEO',
                'alanlar'  => [
                    ...
                    ['alan' => 'mimarlik_gorsel',      'baslik' => 'Hero — Mimarlık Kart Görseli',                'tip' => 'gorsel',   'sira' => 3],
                    ['alan' => 'insaat_gorsel',        'baslik' => 'Hero — İnşaat Kart Görseli',                  'tip' => 'gorsel',   'sira' => 4],
                    ['alan' => 'icmimari_gorsel',      'baslik' => 'Hero — İç Mimari Kart Görseli',               'tip' => 'gorsel',   'sira' => 5],
                    ['alan' => 'magaza_insaat_gorsel', 'baslik' => 'Hero — İnşaat Malzemeleri Mağaza Kart Görseli', 'tip' => 'gorsel', 'sira' => 6],
                    ['alan' => 'magaza_spor_gorsel',   'baslik' => 'Hero — Spor Malzemeleri Mağaza Kart Görseli', 'tip' => 'gorsel',   'sira' => 7],
                    ['alan' => 'koleksiyon_gorsel',    'baslik' => 'Hero — Koleksiyon Kart Görseli',              'tip' => 'gorsel',   'sira' => 8],
                    ['alan' => 'celikag_gorsel',       'baslik' => 'Hero — Çelik Güvenlik Ağı Kart Görseli',      'tip' => 'gorsel',   'sira' => 9],
                    ['alan' => 'hafifcelik_gorsel',    'baslik' => 'Hero — Hafif Çelik ve Konteyner Kart Görseli','tip' => 'gorsel',   'sira' => 10],
                    ['alan' => 'yaklasim_baslik',   'baslik' => 'Yaklaşım Başlığı',        'tip' => 'metin',    'sira' => 11],
                    ['alan' => 'yaklasim_metin',    'baslik' => 'Yaklaşım Metni',          'tip' => 'textarea', 'sira' => 12],
                    ['alan' => 'yaklasim_gorsel',   'baslik' => 'Yaklaşım Görseli',        'tip' => 'gorsel',   'sira' => 13],
                    ['alan' => 'ref_1_metin',       'baslik' => 'Referans 1 — Metin',      'tip' => 'textarea', 'sira' => 14],
                    ['alan' => 'ref_1_ad',          'baslik' => 'Referans 1 — Ad',         'tip' => 'metin',    'sira' => 15],
                    ['alan' => 'ref_1_unvan',       'baslik' => 'Referans 1 — Unvan',      'tip' => 'metin',    'sira' => 16],
                    ['alan' => 'ref_2_metin',       'baslik' => 'Referans 2 — Metin',      'tip' => 'textarea', 'sira' => 17],
                    ['alan' => 'ref_2_ad',          'baslik' => 'Referans 2 — Ad',         'tip' => 'metin',    'sira' => 18],
                    ['alan' => 'ref_2_unvan',       'baslik' => 'Referans 2 — Unvan',      'tip' => 'metin',    'sira' => 19],
                    ['alan' => 'ref_3_metin',       'baslik' => 'Referans 3 — Metin',      'tip' => 'textarea', 'sira' => 20],
                    ['alan' => 'ref_3_ad',          'baslik' => 'Referans 3 — Ad',         'tip' => 'metin',    'sira' => 21],
                    ['alan' => 'ref_3_unvan',       'baslik' => 'Referans 3 — Unvan',      'tip' => 'metin',    'sira' => 22],
                    ['alan' => 'seo_baslik',        'baslik' => 'SEO — Sayfa Başlığı (Google\'da görünen)',    'tip' => 'metin',    'sira' => 23],
                    ['alan' => 'seo_aciklama',      'baslik' => 'SEO — Meta Açıklaması (Google\'da görünen)', 'tip' => 'textarea', 'sira' => 24],
                ],
            ],
            'mimarlik' => [
                'baslik'   => 'Mimarlık',
            ...
            'celik-guvenlik-agi' => [
                ...
                'alanlar'  => [
                    ['alan' => 'logo',           'baslik' => 'MESH Logo',                      'tip' => 'gorsel',   'sira' => 1],
                    ['alan' => 'hero_gorsel',    'baslik' => 'Hero Arka Plan Görseli',         'tip' => 'gorsel',   'sira' => 2],
                    ['alan' => 'hero_metin',     'baslik' => 'Hero Açıklama Metni',            'tip' => 'textarea', 'sira' => 3],
                    ['alan' => 'hizmet_1_gorsel','baslik' => 'Uygulama Alanı 1 — Görsel',      'tip' => 'gorsel',   'sira' => 4],
                    ['alan' => 'hizmet_1',       'baslik' => 'Uygulama Alanı 1 — Açıklama',   'tip' => 'textarea', 'sira' => 5],
                    ['alan' => 'hizmet_2_gorsel','baslik' => 'Uygulama Alanı 2 — Görsel',      'tip' => 'gorsel',   'sira' => 6],
                    ['alan' => 'hizmet_2',       'baslik' => 'Uygulama Alanı 2 — Açıklama',   'tip' => 'textarea', 'sira' => 7],
                    ['alan' => 'hizmet_3_gorsel','baslik' => 'Uygulama Alanı 3 — Görsel',      'tip' => 'gorsel',   'sira' => 8],
                    ['alan' => 'hizmet_3',       'baslik' => 'Uygulama Alanı 3 — Açıklama',   'tip' => 'textarea', 'sira' => 9],
                    ['alan' => 'proje_1_gorsel', 'baslik' => 'Referans Proje 1 — Görsel',      'tip' => 'gorsel',   'sira' => 10],
                    ['alan' => 'proje_2_gorsel', 'baslik' => 'Referans Proje 2 — Görsel',      'tip' => 'gorsel',   'sira' => 11],
                    ['alan' => 'proje_3_gorsel', 'baslik' => 'Referans Proje 3 — Görsel',      'tip' => 'gorsel',   'sira' => 12],
            ...
            'hafif-celik-konteyner' => [
                'baslik'   => 'Hafif Çelik ve Konteyner',
                'ikon'     => 'ti-building-warehouse',
                'aciklama' => 'Hafif çelik ve konteyner proje galerisi sayfası — hero',
                'alanlar'  => [
